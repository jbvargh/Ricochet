...
export function CandidatePanel({
  ...
  return (
    <div className="mx-auto mb-4 max-w-[720px] rounded-sm border border-red-700/30 bg-neutral-900/90 p-4 shadow-lg backdrop-blur">
      ...
      <ul className="flex flex-col gap-3">
        {candidates.map((c, i) => (
          <li
            key={`${c.title}-${i}`}
            className="rounded-sm border border-neutral-800 bg-neutral-950/60 p-3"
          >
